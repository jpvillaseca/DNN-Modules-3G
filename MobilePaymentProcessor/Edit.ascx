<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="Christoc.Modules.MobilePaymentProcessor.Edit" %>
...
<div class="dnnForm dnnEditBasicSettings" id="dnnEditBasicSettings">
    ...
    <fieldset>
        <div class="dnnFormItem">
            <dnn:label ID="lblCommerceCode" runat="server" />
            <asp:TextBox ID="txtCommerceCode" runat="server" />
        </div>
