...
namespace Christoc.Modules.MobilePaymentProcessor
{
    ...
    /// 
    /// Because the control inherits from MobilePaymentProcessorSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : MobilePaymentProcessorModuleSettingsBase
    {
